...
idxToUci = [
    ...
    "b2a1q", "b2a1r", "b2a1b", "b2a1n", "b2b1q", "b2b1r", "b2b1b", "b2b1n",
    "b2c1q", "b2c1r", "b2c1b", "b2c1n", "c2b1q", "c2b1r", "c2b1b", "c2b1n",
    "c2c1q", "c2c1r", "c2c1b", "c2c1n", "c2d1q", "c2d1r", "c2d1b", "c2d1n",
    "d2c1q", "d2c1r", "d2c1b", "d2c1n", "d2d1q", "d2d1r", "d2d1b", "d2d1n",
    "d2e1q", "d2e1r", "d2e1b", "d2e1n", "e2d1q", "e2d1r", "e2d1b", "e2d1n",
    "e2e1q", "e2e1r", "e2e1b", "e2e1n", "e2f1q", "e2f1r", "e2f1b", "e2f1n",
    "f2e1q", "f2e1r", "f2e1b", "f2e1n", "f2f1q", "f2f1r", "f2f1b", "f2f1n",
    "f2g1q", "f2g1r", "f2g1b", "f2g1n", "g2f1q", "g2f1r", "g2f1b", "g2f1n",
...
def valid_moves(board):
  move_array = np.zeros(action_space, dtype=np.float32)
